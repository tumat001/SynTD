...
enum {
	...
	# MORPHS (500)
	BARE__PASSED_PLATE_SHIELD_EFFECT = 500
	BARE__FOOTWORK_FIRST_SPEED = 501
	BARE__FOOTWORK_SECOND_SPEED = 502
	...
	IMPEDE_ING_EFFECT_STUN_EFFECT = -613
	...
	MAP_RIFT__RIFT_SPEED_EFFECT = -5002
	MAP_RIFT__RIFT_INVIS_EFFECT = -5003
	
	MAP_MEMORIES__ENEMY_DREAM__HEAL_EFFECT = -5004
	MAP_MEMORIES__ENEMY_MEMORIA__INVIS_EFFECT = -5005
	
	
	
	ABSTRACT_ENEMY__IS_FADING_USING_TWEEN__INVUL_EFFECT = -6000
