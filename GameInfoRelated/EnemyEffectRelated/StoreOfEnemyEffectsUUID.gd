...
enum {
	...
	ENERVATE_SHRIVEL_TOU_REDUC_EFFECT = -117
	ENERVATE_STUN_EFFECT = -118
	ENERVATE_SLOW_EFFECT = -119
	ENERVATE_DEATH_ON_HIT_DMG = -120
	ENERVATE_HEAL_DECAY_EFFECT = -121
	ENERVATE_SHIELD_DECAY_EFFECT = -122
