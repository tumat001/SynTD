...
func _init(arg_tier : int).(StoreOfPactUUID.PactUUIDs.PERSONAL_SPACE, "Personal Space", arg_tier):
	...
	if tier == 0:
		possible_speed_gain_values = [80, 100, 150]
		possible_range_values = [50, 75, 125]
	elif tier == 1:
		possible_speed_gain_values = [55, 65, 100]
		possible_range_values = [50, 75, 125]
	elif tier == 2:
		possible_speed_gain_values = [35, 45, 70]
		possible_range_values = [50, 75, 125]
	elif tier == 3:
		possible_speed_gain_values = [15, 25, 50]
		possible_range_values = [50, 75, 125]
