...
const vio_side_ing_upgrade_amount__tier_4 : float = 0.20
const vio_side_ing_upgrade_amount__tier_3 : float = 0.30
const vio_side_ing_upgrade_amount__tier_2 : float = 0.50
const vio_side_ing_upgrade_amount__tier_1 : float = 0.75
