...
const armor_pierce_amount : float = 12.0
const toughness_pierce_amount : float = 12.0
...
func _init().(StoreOfTowerEffectsUUID.ING_LEADER):
	...
	description = "Tower gains all targeting options, and receives 12 armor and toughness pierce."
