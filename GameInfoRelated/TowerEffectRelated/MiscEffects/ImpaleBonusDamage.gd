...
func _init().(StoreOfTowerEffectsUUID.ING_SPIKE):
	...
	description = "All of the tower's attacks deal 30% more damage to enemies below 75% health. The damage bonus is increased to 50% against Normal typed enemies."
